...
from fastfurniture.models import Album, AlbumImage
from fastfurniture.forms import AlbumForm
        ...
        if form.is_valid():
            ...
            if form.cleaned_data['zip'] != None:
                ...
                for filename in sorted(zip.namelist()):
                    ...
                    filepath = '{0}/albums/{1}'.format(FASTCat.settings.MEDIA_ROOT, filename)
